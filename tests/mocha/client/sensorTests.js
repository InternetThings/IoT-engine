...
MochaWeb.testOnly(function() {
    ...
    describe('sensor registration', function() {
        ...
        describe('posting data to the platform', function() {
            ...
            it('should have an accesstoken with a sensor in the list', function() {
                var accessToken = AccessTokens.find({}, {
                    fields: {
                        _id: 1,
                        location: 1,
                        type: 1
